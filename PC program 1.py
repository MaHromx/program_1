...
def signin():
    ...
    if username=='admin' and password=='1234':
        ...
        #heading=Label(screen,text='Menu', font='Arial 30 bold', bg='white', fg='#57a1f8')
        #heading.pack(pady=10)
        # Button(frame,width=39,pady=7,text='Textové pole', bg='#57a1f8',fg='white',border=0,command=textfield).place(x=35,y=204)
